...
function impulse_press_register_scripts()
{
    ...
    wp_register_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap-3.0.0.min.js', array( 'jquery' ),null, false );
    ...
    wp_register_script( 'validate', get_template_directory_uri() . '/js/jquery.validate.min.js', array( 'jquery' ),null, false );
...
function impulse_press_register_styles()
{
    ...
    wp_register_style( 'bootstrap-theme', get_template_directory_uri() . '/css/bootstrap-theme.css', array(), null, 'all' );
